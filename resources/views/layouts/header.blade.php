...
<html lang="en">
  <head>
	...
	<link rel="icon" href="https://www.nicelogo.com/images/nice-logo-portfolio/jack-oneill-logo-designer.jpg" type="image/ico" />
    ...
    <!-- iCheck -->
    <link href="{{ URL::asset('') }}plugins/vendors/iCheck/skins/flat/green.css" rel="stylesheet">
	
    <!-- bootstrap-progressbar -->
    <link href="{{ URL::asset('') }}plugins/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="{{ URL::asset('') }}plugins/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
